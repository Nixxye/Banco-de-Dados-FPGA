...
4. Para testes em PC, use tcpserver.py e fpga_test.py.

Notas de integracao

1. O modulo user_hw expõe registradores Avalon-MM de 32 bits para controle, dados, instruções, status e resultados.
